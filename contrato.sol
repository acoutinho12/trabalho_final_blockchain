...
contract TrabalhoFinalBlockChainEleicao {
    ...
    bool private isVoteOpened;

    /// Create a new ballot
    constructor() {
        chairperson = msg.sender;
        voters[chairperson].weight = 1;
        voters[chairperson].name = "Andre Luis Barbosa Coutinho";
        votersAddress.push(chairperson);
        isVoteOpened = true;
    }
    ...
    function giveRightToVote(address voter, string memory name) public {
        ...
        require(isOpened() == true, "Ballot closed");
        require(
        ...
        require(
            ...
            "The voter alredy have the right to vote"
        );
    ...
    function delegate(address to) public {
        ...
        require(
            voters[to].weight >= 1,
            "The voter don't have the right to vote"
        );
    ...
    function getProposalsCount() public view returns (uint256 count) {
    ...
    function getVoterList() public view returns (Voter[] memory) {
        Voter[] memory voterList = new Voter[](votersAddress.length);
        for (uint256 i = 0; i < votersAddress.length; i++) {
            address addr = votersAddress[i];
